...
//Escribe tu código aquí
let miString = "Hola";          // String
let miNumber = 25;              // Number
let miBoolean = true;           // Boolean
let miNull = null;               // Null
let miUndefined;                 // Undefined
let miObject = { tema: "JS" };   // Object
let miArray = [1, 2, 3];         // Array

console.log(miString, miNumber, miBoolean, miNull, miUndefined, miObject, miArray);
...
let v1 = 1;
let v2 = 2;
let comparacionInicial = v1 == v2; 
console.log(comparacionInicial); 

// Ejercicio 10: Crea otra variable que compare las dos primeras variables creadas en el ejercicio anterior, para que el resultado impreso en la consola sea true.

//Escribe tu código aquí

let comparacionTrue = v1 < v2; 
...
let num3 = 1;
let num3AsString = "1";
let result = num3 === num3AsString; // False porque uno es número y otro es string
console.log(result);
...
console.log(result2)
*/
let result2 = num3 == num3AsString; // True porque el valor es el mismo
console.log(result2);
...
// res: true porque 6 < 10 Y 3 > 1
let res = a < 10 && b > 1; 
console.log(res);

// res2: false porque b < 1 es falso (3 no es menor que 1)
let res2 = a < 10 && b < 1; 
console.log(res2);

// res3: false porque ninguna se cumple (ni 6 es 5, ni 3 es 5)
let res3 = a == 5 || b == 5; 
console.log(res3);

// res4: true porque a == 6 es verdad (con el OR basta una)
let res4 = a == 6 || b == 0; 
console.log(res4);

// res5: true porque b == 3 es verdad
let res5 = a == 0 || b == 3; 
console.log(res5);

// res6: true porque ambas son verdad (6 == 6 Y 3 == 3)
let res6 = a == 6 && b == 3; 
console.log(res6);